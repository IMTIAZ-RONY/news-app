      ...
      theme:ThemeData(
        ...
        textButtonTheme:TextButtonThemeData(
            style:TextButton.styleFrom(
                ...
                textStyle:const TextStyle(color:Colors.blueAccent,fontSize:18,fontWeight:FontWeight.w700   )

            )
        ),

        textTheme: const TextTheme(
          titleLarge:TextStyle(color:Colors.pink,fontSize: 24,fontWeight:FontWeight.w900 , ) ,
          titleMedium:TextStyle(color:Colors.green,fontSize: 18,fontWeight:FontWeight.w700 , )  ,
          titleSmall: TextStyle(color:Colors.pink,fontSize: 16,fontWeight:FontWeight.w500 , ) ,
        ),
